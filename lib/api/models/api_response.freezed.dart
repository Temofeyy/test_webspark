...
class _$ApiResponseImpl implements _ApiResponse {
  const _$ApiResponseImpl(@JsonKey(name: 'error') this.isError, this.message,
  ...
  @override
  String toString() {
    return 'ApiResponse(isError: $isError, message: $message, data: $data)';
  }
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse(
      @JsonKey(name: 'error') final bool isError,
      final String message,
      final List<Map<String, dynamic>> data) = _$ApiResponseImpl;
