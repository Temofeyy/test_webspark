...
abstract class $ResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Point> steps, String path});
}
...
class _$ResultImpl implements _Result {
  const _$ResultImpl({required final List<Point> steps, required this.path})
      : _steps = steps;
...
abstract class _Result implements Result {
  const factory _Result(
      {required final List<Point> steps,
      required final String path}) = _$ResultImpl;
